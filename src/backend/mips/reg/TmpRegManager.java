...
public class TmpRegManager{
	...
	public TmpRegManager(MipsManager mipsManager){
	...
	public void initSpare(){ this.spare = new LinkedHashSet<>(RegManager.TMP_REG); }
	...
	public String toString(){
		StringBuilder ret = new StringBuilder("----------TmpReg------------");
		ret.append("\nspare: ");
